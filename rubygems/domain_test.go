...
func TestHostWiring(t *testing.T) {
	...
	if want := "rubygems://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("rubygems", "about")
	if err != nil || got.String() != "rubygems://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want rubygems://page/about", got.String(), err)
	}
}
