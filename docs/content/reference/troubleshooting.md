...
Most of these come down to network reality or how rubygems serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

rubygems rate-limits like any public site. rubygems already paces
...
Where a surface is gated, rubygems reads a cookie or token you supply
...
`rubygems`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what rubygems actually did
